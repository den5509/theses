...
- Jessie Frazelle's: Docker Containers on the Desktop (https://blog.jessfraz.com/post/docker-containers-on-the-desktop/) (дата обращения 7 апреля 2017).
- Андрей Маркелов: OpenStack. Практическое знакомство с облачной операционной системой издание "ДМК-Пресс" (2016).
